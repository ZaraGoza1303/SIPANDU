        ...
        <div className="flex flex-wrap gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-72 rounded-xl border pl-11 pr-4 py-3 outline-none focus:border-blue-500"
            />
          </div>
          ...
          <tbody>
            {loading ? (
              ...
              patients.map((patient) => (
                ...
                >
                  <td className="p-5">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-lg">
                      👶
                    </div>
                  </td>
