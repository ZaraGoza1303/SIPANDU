...
export default function MainLayout({
  ...
  // =========================================================
  // MOBILE: tutup menu setelah pindah halaman
  // =========================================================
  useEffect(() => {
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <div>
              ...
              <p className="mt-1 text-[9px] leading-none text-gray-400">
          ...
          >
            ...
            {!isCollapsed && (
              <button
                ...
                className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-gray-400 transition hover:bg-gray-100 hover:text-gray-600"
